...
public final class GooglePlayServicesUtil
{
    ...
    public static Dialog a(final int n, final Activity activity, final int n2, final DialogInterface$OnCancelListener onCancelListener, final int n3) {
        ...
        final I i = new I(activity, a((Context)activity, n, n3), n2);
        final String b = b((Context)activity, n);
        if (b != null) {
            setMessage.setPositiveButton((CharSequence)b, (DialogInterface$OnClickListener)i);
        }
        switch (n) {
            default: {
                Log.e("GooglePlayServicesUtil", "Unexpected error code " + n);
                return (Dialog)setMessage.setTitle(Z.f).create();
            }
            case 0: {
                return null;
            }
            ...
            case 1: {
                return (Dialog)setMessage.setTitle(Z.a).create();
            }
            case 3: {
                return (Dialog)setMessage.setTitle(Z.Z).create();
            }
            case 2: {
                return (Dialog)setMessage.setTitle(Z.l).create();
            }
            case 9: {
                Log.e("GooglePlayServicesUtil", "Google Play services is invalid. Cannot recover.");
                return (Dialog)setMessage.setTitle(Z.i).create();
            }
            case 7: {
                Log.e("GooglePlayServicesUtil", "Network error occurred. Please retry request later.");
                return (Dialog)setMessage.setTitle(Z.e).create();
            }
            case 8: {
            ...
            case 5: {
                ...
                return (Dialog)setMessage.setTitle(Z.c).create();
            }
            case 11: {
    ...
    public static Intent a(final Context context, final int n, final int n2) {
        switch (n) {
            ...
            case 2: {
                if (!n(n2)) {
                    return com.google.android.gms.internal.Z.I("com.google.android.gms");
                }
                if (o(context)) {
                    return com.google.android.gms.internal.Z.Z("com.google.android.gms");
                }
                return com.google.android.gms.internal.Z.I("com.google.android.apps.bazaar");
            }
            case 3: {
                return com.google.android.gms.internal.Z.Code("com.google.android.gms");
            }
            case 12: {
                return com.google.android.gms.internal.Z.Code();
            }
        }
    }
    ...
    private static byte[] a(final PackageInfo p0, final byte[]... p1) {
        ...
        //   157: dup            
        //   158: ldc_w           "Signature not valid.  Found: \n"
        //   161: invokespecial   java/lang/StringBuilder.<init>:(Ljava/lang/String;)V
        //   164: aload_0        
        //   165: iconst_0       
        //   166: invokestatic    android/util/Base64.encodeToString:([BI)Ljava/lang/String;
        ...
        //   175: invokestatic    android/util/Log.v:(Ljava/lang/String;Ljava/lang/String;)I
        //   178: pop            
        //   179: aconst_null    
        //   180: areturn        
        //    Exceptions:
    ...
    public static boolean aI() {
        if (GooglePlayServicesUtil.iX) {
            return GooglePlayServicesUtil.iY;
        }
    ...
    public static String b(final Context context, final int n) {
        ...
        switch (n) {
            ...
            case 1: {
                return resources.getString(Z.J);
            }
            case 3: {
                return resources.getString(Z.Code);
            }
            case 2: {
                return resources.getString(Z.j);
            }
    ...
    public static String b(final Context context, final int n, final int n2) {
        ...
        switch (n) {
            default: {
                s = resources.getString(Z.f);
                break;
            }
            case 1: {
                String s2;
                if (a(context.getResources())) {
                    s2 = resources.getString(Z.C);
                }
                else {
                    s2 = resources.getString(Z.B);
                }
                s = s2;
                if (n(n2)) {
            ...
            case 3: {
                return resources.getString(Z.I);
            }
            case 2: {
                s = resources.getString(Z.k);
                if (n(n2)) {
                    return s + " (via Bazaar)";
                }
                break;
            ...
            case 9: {
                return resources.getString(Z.h);
            }
            case 7: {
                return resources.getString(Z.d);
            }
            case 5: {
                return resources.getString(Z.b);
            }
            case 12: {
                return resources.getString(Z.g);
            }
        }
        return s;
    }
    ...
    public static int isGooglePlayServicesAvailable(final Context context) {
        ...
        while (true) {
            try {
                context.getResources().getString(Z.f);
        ...
        byte[] a;
        try {
            a = a(packageManager.getPackageInfo("com.android.vending", 64), GooglePlayServicesUtil.iQ);
            if (a == null) {
        ...
        if (packageInfo.versionCode < 4030500) {
    ...
    private static void n(final Context context) {
        ...
        throw new IllegalStateException("The meta-data tag in your app's AndroidManifest.xml does not have the right value.  Expected 4030500 but found " + int1 + ".  You must have the following declaration within the <application> element:     <meta-data android:name=\"com.google.android.gms.version\" android:value=\"@integer/google_play_services_version\" />");
    }
    ...
    private static boolean o(final Context context) {
        boolean iz = false;
        if (GooglePlayServicesUtil.iX) {
            iz = GooglePlayServicesUtil.iZ;
        }
        else {
            try {
                if (a(context.getPackageManager().getPackageInfo("com.google.android.apps.bazaar", 64), GooglePlayServicesUtil.iW) != null) {
                    return true;
                }
            }
            catch (PackageManager$NameNotFoundException ex) {
    ...
    private static byte[] t(final String s) {
        try {
